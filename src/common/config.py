...
class Config:
    ...
    def init_config_data(cls):
        cls.test_window_shown = False
        cls.thread_debug_level = 4
        cls.default_thread_type = 'fed'
        cls.developer_mode = False
    ...
    def save(cls):
        config_data = {
            'test_window_shown': cls.test_window_shown,
